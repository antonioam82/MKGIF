...
# ─────────────────────────────────────────────
# MEJORA 3: Estado centralizado — sin globales
# ─────────────────────────────────────────────
@dataclass
class AppState:
    stop: bool = False
...
# ─────────────────────────────────────────────
# MEJORA 2: Generador de frames — menos RAM
# ─────────────────────────────────────────────
...
def create_gif(args, state: AppState) -> None:
    ...
    try:
        ...
        # ─────────────────────────────────────────────
        # MEJORA 6: Precalcular dimensiones una sola vez
        # ─────────────────────────────────────────────
        ...
        # ─────────────────────────────────────────────
        # MEJORA 4: Filtro adaptativo según escala
        # ─────────────────────────────────────────────
        resample = Image.LANCZOS if factor > 0.5 else Image.BILINEAR

        # ─────────────────────────────────────────────
        # MEJORA 1: Redimensionar frames en paralelo
        # ─────────────────────────────────────────────
        ...
        if state.done:
            ...
            # ─────────────────────────────────────────────
            # MEJORA 5: Flag --optimize opcional
            # ─────────────────────────────────────────────
...
def read_video(args, state: AppState) -> None:
    ...
    try:
        ...
        # ─────────────────────────────────────────────
        # MEJORA 2: Usar generador en lugar de lista global
        # ─────────────────────────────────────────────
...
def main():
    ...
    if file_extension == '.webp':
        ...
        # MEJORA 7: total_frames se pasa a través del estado — no hay riesgo de uso antes de definición
